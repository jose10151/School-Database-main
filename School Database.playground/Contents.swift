...
struct School{
    ...
    func printFavoriteTeacherInfo(for student :Student){
       if let teacher =  getTeacher(withID: student.favoriteTeacherID)
        {
           print(teacher.name)
           print(" \(teacher.hairColor ?? "no") hair")
           if let t = teacher.email {
               print(t)
           }
...
var t1 = Teacher(name: "Antigua", id: 1234, email: nil, hairColor: "brown")
var t2 = Teacher(name: "Lisette", id: 5678, email: nil, hairColor: "brown")
var t3 = Teacher(name: "lily", id: 9101, email: nil, hairColor: "brown")

var teacher:[Teacher] = [t1, t2, t3]

let school = School(name: "STEM", teachers:teacher)

var j = Student(name: "Jose", favoriteTeacherID: 0)
var l = Student(name: "Lose", favoriteTeacherID: 9101)

school.printFavoriteTeacherInfo(for: j)
school.printFavoriteTeacherInfo(for: l)
